...
plots.individual_plots.plev="[200]" \
...
plots.individual_plots.central_latitude=45 \
plots.individual_plots.colourbar.tick_every=2 \
plots.individual_plots.colour_scheme=PuOr \
...
plots.zonal_mean.special_outdir="test"
