...
plots.individual_plots.variable="tos" \
...
plots.individual_plots.special_outdir="" \
...
plots.individual_plots.individual.lat0=23.5 \
plots.individual_plots.individual.lat1=90 \
plots.individual_plots.individual.lon0=0 \
plots.individual_plots.individual.lon1=360 \
...
plots.individual_plots.colour_scheme=ygb_custom \
